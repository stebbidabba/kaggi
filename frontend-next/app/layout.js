...
function Header() {
  ...
  return (
    <header className={`sticky top-0 z-50 w-full ${mPlusRounded.className}`} style={{ background: "var(--header-bg)", fontWeight: 500, borderBottom: 0 }}>
...
export default function RootLayout({ children }) {
  useEffect(() => { document.documentElement.lang = 'is'; }, []);
  return (
    <html lang="is">
      <head>
