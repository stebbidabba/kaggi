      ...
      <div className="max-w-3xl mx-auto px-4 py-6">
        ...
        {activeTab === 'test-report' && (
          <div className="text-center py-16">
            ...
            <p className="text-[#044046] mb-8 leading-relaxed max-w-md mx-auto">
              All cars sold through Kaggi must be tested by NAF or Viking Kontroll. After testing you will find your test report in this tab.
            </p>
          </div>
        )}
        ...
        {activeTab === 'bidding-round' && (
          <div className="text-center py-16 text-gray-500">
            <p>Bidding round starts after inspection</p>
          </div>
        )}
      </div>
    </div>
